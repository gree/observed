...
module Observed
  ...
  class Singleton
    ...
    def_delegators :@observed, :require_relative, :observe, :translate, :report, :write, :read, :emit, :receive, :config, :load!, :working_directory
  ...
  def_delegators :@@singleton, :run, :init!, :configure, :require_relative, :observe, :translate, :report, :write, :read, :emit, :receive, :config,
